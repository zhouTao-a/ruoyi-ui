<template>
  <div class="p-2">
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="recTaskFormRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="标题" prop="title">
        ...
        <el-form-item label="截止日期" prop="deadLine">
          <el-date-picker clearable v-model="form.deadLine" type="date" value-format="YYYY-MM-DD" placeholder="请选择截止日期"></el-date-picker>
        </el-form-item>
